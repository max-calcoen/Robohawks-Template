#include "vex.h"
#include "classes/chassisClass.h"
...
void TankChassis::drive(directionType dir, double dist, double speed) {
  double revolutions = dist / (WHEEL_DIAMETER * M_PI);
  ...
  const double ERROR_MARGIN_DEGREES = ERROR_MARGIN_INCHES * 360 / (WHEEL_DIAMETER * M_PI);
